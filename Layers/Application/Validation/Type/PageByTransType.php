...
class PageByTransType extends AbstractType
{
    ...
    public function setInit($container, $locale = '', $roles_user = array()) {
        ...
        if (empty($locale)) {
            $locale = $this->_container->get('request_stack')->getCurrentRequest()->getLocale();
        }
        ...
        $builder
            ...
            ->add('user', 'entity', array(
                    ...
                    "attr" => array(
                        ...
                        "data-url"=>$this->_container->get('sfynx.tool.route.factory')->generate("users_selectentity_ajax"),
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
                'data_class' => 'Sfynx\CmfBundle\Layers\Domain\Entity\Page',
                'rubrique_show' => true,
