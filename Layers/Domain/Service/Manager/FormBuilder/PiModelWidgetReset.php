 ...
 */
namespace Sfynx\CmfBundle\Layers\Domain\Service\Manager\FormBuilder;
                ...
                'xml'         => Array (
                        "widgets"     => Array (
                                "user"        => Array (
                                        ...
                                        "params"        => Array (
                                                "template"             => $this->container->getParameter('sfynx.template.theme.login') . "Resetting:" . $data['template'],
