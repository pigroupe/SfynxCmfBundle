...
abstract class PiCoreManager implements PiCoreManagerBuilderInterface
{
    ...
    /**
     * @var array of \Sfynx\CmfBundle\Layers\Domain\Entity\Page
     */
    protected $pages = [];

    /**
     * @var \Sfynx\CmfBundle\Layers\Domain\Entity\TransaltionPage
     */
    ...
    /**
     * @var array of \Sfynx\CmfBundle\Layers\Domain\Entity\Block
     */
    protected $blocks = [];

    /**
     * @var array of \Sfynx\CmfBundle\Layers\Domain\Entity\Widget
     */
    protected $widgets = [];
...
//                $v = str_replace('\\\\', '\\', $v);
     ...
     * @since  2012-04-19
     */
    protected function setResponse($Etag, Response $response)
    {
    ...
    {
        // we get query string
        if (null !== $qs = $this->container->get('request_stack')->getCurrentRequest()->getQueryString()) {
            return true;
        }
        return false;
    }
